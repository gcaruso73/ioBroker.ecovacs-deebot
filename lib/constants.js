...
module.exports = {
    ...
    /**
     * After an automatic token refresh, the primary device's owned MQTT client
     * is replaced asynchronously by the library (client.end -> connect). We poll
     * for the new client to become available so secondary (shared) devices can
     * re-subscribe through it. These bound that polling.
     */
    TOKEN_REFRESH_REATTACH_INTERVAL_MS: 500,
    TOKEN_REFRESH_REATTACH_MAX_ATTEMPTS: 30
};
