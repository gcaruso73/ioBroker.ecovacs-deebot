...
class Model {
     ...
     * Falls back to `deviceType` for backward compatibility with older library versions.
    ...
    getDeviceCategory() {
        return this.vacbot.getDeviceCategory
            ...
            : this.vacbot.getDeviceProperty('deviceCategory',
                this.vacbot.getDeviceProperty('deviceType', 'Unknown Device'));
    }
