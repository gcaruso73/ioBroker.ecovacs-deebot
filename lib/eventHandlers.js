        ...
        return new Promise((resolve) => {
            ...
            vacbot.on('ready', () => {
                ...
                (async () => {
                    ...
                    ctx.adapterProxy.setStateConditional('info.modelType', ctx.getPlatformType(), true);
                    ctx.adapterProxy.setStateConditional('info.deviceType', ctx.getModel().getDeviceCategory(), true);
